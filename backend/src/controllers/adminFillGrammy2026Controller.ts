...
const DADOS: Record<string, Indicado[]> = {
  ...
  "BEST DANCE RECORDING": [
    { artista: "Angela", titulo: "Masked", vencedor: false },
    { artista: "ANGELA X RED", titulo: "CINDER STAR", vencedor: false },
    { artista: "Bremm & Louise", titulo: "Storm", vencedor: false },
    { artista: "Emma", titulo: "Crying My Name", vencedor: false },
    { artista: "SA5M", titulo: "Bimbofication", vencedor: true },
    { artista: "TED", titulo: "Miss Perfect Blonde feat. Alexxa Hills", vencedor: false },
  ],
  "BEST DANCE SONG": [
    { artista: "ANGELA X RED", titulo: "CINDER STAR", vencedor: false },
    { artista: "Bremm & Louise", titulo: "Storm", vencedor: false },
    { artista: "Emma", titulo: "Crying My Name", vencedor: false },
    { artista: "Rayna", titulo: "Listen", vencedor: false },
    { artista: "SA5M", titulo: "Bimbofication", vencedor: true },
    { artista: "TED", titulo: "Miss Perfect Blonde feat. Alexxa Hills", vencedor: false },
  ],
  "BEST POP VOCAL ALBUM": [
    { artista: "EVA", titulo: "HollyWouldn't", vencedor: false },
    { artista: "Matthew", titulo: "Garden Echoes", vencedor: false },
    { artista: "Rayna", titulo: "Wasteland", vencedor: false },
    { artista: "Rose Thompson", titulo: "Gentleman Prefer Blonde", vencedor: true },
    { artista: "SA5M & Moon Girls", titulo: "Coming Of Age Ceremony", vencedor: false },
    { artista: "TED", titulo: "SOLIVAGANT", vencedor: false },
  ],
  "BEST POP DUO/GROUP PERFORMANCE": [
    { artista: "Angela", titulo: "Jukebox Lover feat. Tyler", vencedor: false },
    { artista: "Anníbal Páris", titulo: "YSL Party (feat. SA5M)", vencedor: false },
    { artista: "Paul Carter", titulo: "rainforest (feat. Marco)", vencedor: false },
    { artista: "Raven", titulo: "THE FAME (with Paul Carter)", vencedor: true },
    { artista: "Rose Thompson", titulo: "How to Marry a Millionaire (feat. Raven)", vencedor: false },
    { artista: "SA5M & Moon Girls", titulo: "The Summer I Turned Rover", vencedor: false },
  ],
  "BEST POP SOLO PERFORMANCE": [
    { artista: "Anne Gray", titulo: "Chasing Sunrises", vencedor: false },
    { artista: "Karol Morris", titulo: "GUILTY!", vencedor: false },
    { artista: "Marco", titulo: "Magnum opus", vencedor: false },
    { artista: "Rose Thompson", titulo: "Britannica", vencedor: true },
    { artista: "SA5M", titulo: "Bimbofication", vencedor: false },
    { artista: "TED", titulo: "The Protagonist", vencedor: false },
  ],
  "BEST NEW ARTIST": [
    { artista: "Angela", titulo: "", vencedor: true },
    { artista: "Loreena", titulo: "", vencedor: false },
    { artista: "Overdrive", titulo: "", vencedor: false },
    { artista: "Zoe Lane", titulo: "", vencedor: false },
  ],
  "SONG OF THE YEAR": [
    { artista: "Emma", titulo: "Crying My Name", vencedor: false },
    { artista: "EVA", titulo: "Hot Lens 70mm", vencedor: false },
    { artista: "Marco", titulo: "Brand", vencedor: false },
    { artista: "Raven", titulo: "THE FAME (with Paul Carter)", vencedor: false },
    { artista: "Rose Thompson", titulo: "Britannica", vencedor: false },
    { artista: "SA5M", titulo: "Bimbofication", vencedor: false },
    { artista: "Sabine", titulo: "Saudade do Asfalto", vencedor: true },
    { artista: "TED", titulo: "The Protagonist", vencedor: false },
  ],
  ...
  "ALBUM OF THE YEAR": [
    { artista: "Angela", titulo: "ANGELA", vencedor: false },
    { artista: "EVA", titulo: "HollyWouldn't", vencedor: false },
    { artista: "Matthew", titulo: "Garden Echoes", vencedor: false },
    { artista: "Paul Carter", titulo: "Evergreen", vencedor: false },
    { artista: "Rayna", titulo: "Wasteland", vencedor: false },
...
const SEGMENTO_FALLBACK: Record<string, string> = {
  ...
  "BEST DANCE RECORDING": "Dance/Electronic",
  "BEST DANCE SONG": "Dance/Electronic",
  "BEST POP VOCAL ALBUM": "Pop",
  "BEST POP DUO/GROUP PERFORMANCE": "Pop",
  "BEST POP SOLO PERFORMANCE": "Pop",
  "BEST NEW ARTIST": "General Field",
  "SONG OF THE YEAR": "General Field",
  "RECORD OF THE YEAR": "General Field",
  "ALBUM OF THE YEAR": "General Field",
};
